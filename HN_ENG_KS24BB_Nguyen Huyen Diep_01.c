...
int main(){
    ...
    do{
        ...
        printf("3. Dem so luong ca so hoan hao co trong mang\n");
        ...
        printf("10. Kiem tra xem mang co phai la mang giam dan khong\n");
        printf("11. Dao nguoc thu tu cua cac phan tu trong mang, hien thi toan bo phan tu co trong mang theo dang(arr[0]=1-le, arr[1]=2-chan)");
        printf("12. Thoat\n");
        printf("\nLua chon cua ban: ");
        scanf("%d", choice);
        ...
        case 8:
            ...
            case 10:
            printf("\ndao nguoc thu tu cua cac phan tu");
            break;
